...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            company.SetRealtor(new_realtor);
        }
        /// <summary>
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Company company = companies[index];
            company.SetRealEstate(new_realEstate);
        }
        /// <summary>
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (listView1.SelectedIndices.Count > 0)
            {
                ...
                int endRealtors = companies[index].GetRealtorsCount();
                int endRealEstates = companies[index].GetRealEstatesCount();
                for (int i = 0; i < endRealtors; i++)
                {
                    ListViewItem item = new ListViewItem(companies[index].GetRealtor(i));
                    listView2.Items.Add(item);
                }
                for (int i = 0; i < endRealEstates; i++)
                {
                    ListViewItem item = new ListViewItem(companies[index].GetRealEstate(i));
