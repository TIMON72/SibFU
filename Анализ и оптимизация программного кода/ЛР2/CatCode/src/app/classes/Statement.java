...
public class Statement {
    ...
    public Statement(String var, String operation, Expression expr) throws SemanticException {
        ...
        if (!(result instanceof Integer || result instanceof Boolean || result instanceof String
                || result == null))
     ...
     * @throws SemanticException
     */
    public Statement(String funcName, String funcVar, Map<String, Expression> funcArgs, ArrayList<Statement> funcStates) {
        name = "S" + counter++;
        String argsText = " ( ";
        ...
        text = name + " -> " + funcName + " = " + funcVar + argsText + statesText;// + "return " + rtrnExpr.getName();
    }
