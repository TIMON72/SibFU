...
#define _nstates3	51	/* :init: */
#define minseq3	84
#define maxseq3	133
#define _endstate3	50

#define _nstates2	34	/* Sort3 */
#define minseq2	51
#define maxseq2	83
#define _endstate2	33

#define _nstates1	25	/* Sort2 */
#define minseq1	27
#define maxseq1	50
#define _endstate1	24

#define _nstates0	28	/* Sort1 */
#define minseq0	0
#define maxseq0	26
...
#endif
	unsigned _4_6_isPassed : 1;
	int i;
	int result[16];
} P3;
#define Air3	(sizeof(P3) - Offsetof(P3, result) - 16*sizeof(int))

#define PSort3	((P2 *)_this)
typedef struct P2 { /* Sort3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, step) - 1*sizeof(int))

#define PSort2	((P1 *)_this)
typedef struct P1 { /* Sort2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, _2_2_j) - 1*sizeof(int))

#define PSort1	((P0 *)_this)
typedef struct P0 { /* Sort1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned isSorted1 : 1;
	unsigned isSorted2 : 1;
	unsigned isSorted3 : 1;
	uchar STDIN;
	int array[16];
	int sort1[16];
	int sort2[16];
