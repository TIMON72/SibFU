...
namespace MLP
{
    public static class Perceptron
    {
        ...
        static double[] layer1 = new double[9]; // Скрытый слой 1
        ...
        /// <param name="w1"></param>
        /// <param name="w2"></param>
        public static void Initialize(double[] input, double[] layer1, double[] output, double[,] w1, double[,] w2)
        {
            Perceptron.input = input;
            Perceptron.layer1 = layer1;
        ...
        /// <returns></returns>
        static public double Adder(double[] x, double[,] w, int neuron)
        {
            double sumW = 0;
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        static public double ActivationFunc(double t) => 1.0 / (1.0 + Math.Exp(-t));
        /// <summary>
        /// Ответ нейросети
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        static public double Answer(double[] input)
        {
